...
export async function generateMetadata({
  ...
  return {
    ...
    /**
     * Подтверждение прав на сайт для поисковых панелей.
     *
     * Обе строки выдали сами панели: Google Search Console и Яндекс.Вебмастер.
     * Секрета в них нет — они лишь доказывают, что сайтом распоряжаемся мы.
     * Убирать их после подтверждения нельзя: панели проверяют наличие снова.
     */
    verification: {
      google: "RLtJu2qggyHTZ-DvtMb2F0k_Ax1vIBiZfvFzDkrRTvQ",
      yandex: "89287187bb00d6d8",
    },
    /**
